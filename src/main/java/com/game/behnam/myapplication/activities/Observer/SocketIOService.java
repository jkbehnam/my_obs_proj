...
import static com.game.behnam.myapplication.ForegroundService.CHANNEL_ID;
import static com.game.behnam.myapplication.activities.Main.user_id;
import static com.game.behnam.myapplication.activities.Observer.eventList.FragmentEventList.chatURL;
...
public class SocketIOService extends Service implements SocketEventListener.Listener, HeartBeat.HeartBeatListener {
    ...
    public static final String EXTRA_OBSERVER_ID = "extra_event_id";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentText("'سرویس اپلیکیشن داور در حال اجراست")
                .setSmallIcon(R.drawable.ic_expand_arrow)
                .setContentIntent(pendingIntent)
                .addAction(R.drawable.ic_expand_arrow, "قطع سرویس",
                        snoozePendingIntent)
                .setAutoCancel(true)
                .build();
        ...
        if (intent != null) {
            ...
            int eventType = intent.getIntExtra(EXTRA_EVENT_TYPE, EVENT_TYPE_JOIN);
             ...
             observer_id = intent.getStringExtra(EXTRA_OBSERVER_ID);
    ...
    private void joinChat(String ob_id) {
...
//
        ...
        try {
            ...
            jsonObject.put("ob_id", user_id);


            mSocket.emit("join_observer", jsonObject);
    ...
    private void sendMessage(String message, String Nickname) {
        ...
        mSocket.emit("messagedetection", Nickname, message, group_id, observer_id, event_name);
