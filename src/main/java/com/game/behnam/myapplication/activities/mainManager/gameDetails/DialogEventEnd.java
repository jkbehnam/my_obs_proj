...
import com.game.behnam.myapplication.VolleySingleton;
import com.game.behnam.myapplication.utils.OtherGamer;
import com.game.behnam.myapplication.utils.URLs;
...
import static com.game.behnam.myapplication.base.BaseActivity.homecontext;
...
String e_id;
    ...
    public AlertDialog init(Context context, String title, String e_id) {
        ...
        event_detail_btn.setVisibility(View.GONE);
        getRankingList();
