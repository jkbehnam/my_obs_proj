 ...
 */
public class AdapterEventManager extends RecyclerView.Adapter<AdapterEventManager.MyViewHolder> {
    ...
    public AdapterEventManager(ArrayList<Event> data_services_list) {
...
*/
    ...
    public interface OnCardClickListner {
        void OnCardClicked(View view, int position,Event event);
    }
